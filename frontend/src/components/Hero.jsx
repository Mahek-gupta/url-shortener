...
// const Hero = () => {
//   return (
//     <section className="bg-hero-pattern bg-cover bg-center min-h-[90vh] flex flex-col justify-center items-center text-center text-gray-100 px-6 relative">
...
// const Hero = () => {
//   return (
//     <section className="bg-hero-pattern bg-cover bg-center min-h-[90vh] flex flex-col justify-center items-center text-center text-gray-100 px-6 relative overflow-hidden">
//       <motion.div
