...
//           <a href="#" className="hover:text-primary-purple">Terms</a>
//           <a href="#" className="hover:text-primary-purple">Privacy Policy</a>
//           <a href="#" className="hover:text-primary-purple">Contact</a>
//           <a href="https://github.com/your-username/your-repo" target="_blank" rel="noopener noreferrer" className="hover:text-primary-purple">GitHub</a>
//         </div>
//         <div className="flex space-x-4 text-2xl">
//           {/* Placeholder social icons */}
//           <a href="#" className="hover:text-primary-purple">🔗</a> {/* LinkedIn */}
//           <a href="#" className="hover:text-primary-purple">🐙</a> {/* GitHub */}
//           <a href="#" className="hover:text-primary-purple">🐦</a> {/* Twitter */}
//         </div>
//       </div>
//     </footer>
//   );
