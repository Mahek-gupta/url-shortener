    ...
    <section className="relative py-24 bg-[#0f0f1a] text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 max-w-4xl text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-extrabold mb-6 leading-snug bg-gradient-to-r from-purple-400 via-pink-400 to-purple-500 bg-clip-text text-transparent"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.96 }}
          className="relative px-10 py-4 rounded-full text-lg font-bold text-white 
          bg-gradient-to-r from-purple-600 via-pink-600 to-purple-500 
          hover:from-pink-600 hover:to-purple-600
          shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all duration-300
        ...
        <motion.div
          ...
          className="mx-auto mt-10 w-48 h-[2px] bg-gradient-to-r from-pink-500 via-white to-purple-500 origin-left"
        ></motion.div>
      </div>
    </section>
  );
