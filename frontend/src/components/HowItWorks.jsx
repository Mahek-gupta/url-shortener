...
//   <div className="flex flex-col items-center bg-dark-card p-6 rounded-lg shadow-md">
//     <div className="w-12 h-12 flex items-center justify-center bg-primary-purple rounded-full text-light-text text-xl font-bold mb-4">
//       {number}
//     </div>
...
//     {
//       number: 1,
//       icon: '🔗', // Placeholder: <LinkIcon />
//       description: 'Paste your long URL into the input field.',
//     },
//     {
//       number: 2,
//       icon: '🖱️', // Placeholder: <CursorClickIcon />
//       description: 'Click the "Shorten Now" button to generate your link.',
//     },
//     {
//       number: 3,
//       icon: '📤', // Placeholder: <ShareIcon />
//       description: 'Share your new short link or track its performance.',
//     },
//   ];

//   return (
//     <section className="py-16 bg-gradient-to-br from-dark-bg to-gray-900 text-center">
...
//                   <span className="text-primary-purple text-3xl md:text-5xl font-bold">→</span>
//                 </div>
//               )}
//             </React.Fragment>
//           ))}
...
//     icon: Scissors,
//     title: "Click Shorten",
//     description: "Generate a smart, trackable short link instantly.",
//   },
//   {
//     number: "3",
//     icon: Share2,
//     title: "Share or Track",
//     description: "Share your short link and monitor analytics easily.",
//   },
// ];
...
// const HowItWorks = () => {
//   return (
//     <section className="py-24 bg-[#0d0d17] text-white relative overflow-hidden">
...
//         >
//           {/* Animated dotted connector line */}
//           <motion.div
//             initial={{ scaleX: 0 }}
//             whileInView={{ scaleX: 1 }}
//             transition={{ duration: 1.2, delay: 0.4 }}
//             className="hidden md:block absolute top-1/2 left-20 right-20 border-t border-dashed border-purple-400/50 transform -translate-y-1/2 origin-left"
//           ></motion.div>
...
//               bg-gradient-to-br from-[#1a1a2e]/80 to-[#11111f]/80 backdrop-blur-2xl
...
//                 border border-white/20 shadow-inner backdrop-blur-lg"
//               >
...
//               {/* Icon inside glowing ring */}
//               <div className="relative mb-5">
//                 <div className="absolute inset-0 rounded-full blur-md bg-purple-500/40 animate-pulse"></div>
//                 <div className="relative bg-[#181828] rounded-full p-4 border border-white/10">
//                   <step.icon className="text-purple-400 w-7 h-7" />
//                 </div>
//               </div>
...
//                   className="hidden md:block absolute right-[-50px] top-1/2 transform -translate-y-1/2"
//                 >
//                   <svg
...
//                     strokeWidth={2}
//                     stroke="url(#grad)"
//                     className="w-10 h-10 animate-bounce-x"
//                   >
//                     <defs>
...
// const HowItWorks = () => {
//   return (
//     <section className="relative py-24  bg-[#0f0f1] overflow-hidden text-white">
//       {/* --- Background glow --- */}
