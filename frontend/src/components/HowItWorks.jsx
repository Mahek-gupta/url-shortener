    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(25)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-[2px] h-[2px] bg-gray-400/30 dark:bg-white/20 rounded-full"
            initial={{
          ...
          {steps.map((step, i) => (
            <motion.div
              ...
              className="relative flex flex-col items-center text-center p-8 w-72 rounded-2xl
               bg-white/80 dark:bg-gradient-to-br dark:from-[#1a1a2e]/100 dark:to-[#11111f]/100 backdrop-blur-2xl
              border border-gray-200  dark:border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.05)] dark:shadow-[0_0_30px_rgba(255,255,255,0.05)]
            ...
            >
              ...
              >
                ...
                <div className="relative bg-gray-200 dark:bg-[#181828] rounded-full p-4 border border-white/10 ">
                  <step.icon className="text-purple-500 dark:text-purple-400 w-8 h-8" />
                </div>
              </motion.div>
